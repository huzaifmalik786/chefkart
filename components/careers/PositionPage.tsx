    ...
    <div className={Styles.positionPage}>
        ...
        <div className={Styles.main}>
            ...
            <div className={Styles.section}>
                ...
                <ul>
                    {
                        (positionDetails.what_candidate_need).split('\n').map((item, key)=>{
                            return(
                                <li key={key}>{item}</li>
                            )
                        })
